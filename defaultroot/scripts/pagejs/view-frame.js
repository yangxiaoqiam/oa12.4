$(function() {
  ...
  $(".wh-hd-custom-cont").hover(function() {}, function() {
    $("#c-nav-parent").removeClass("open");
  })
  ...
  /*点击添加选项*/
  // $("#cnav-swith-con .wh-hd-custom-menu .fa-plus").click(function(){
  //     var menu_dom = $(this).parent().text();
  //     var currenIndex = $(this).parent().parent().index(); 
  //     var length = $(".wh-hd-l-nav dd").length;
  //     $(".wh-hd-l-nav dd").eq(length-2).after('<dd><div class="wh-hd-custom-menu">'+menu_dom+'</div></dd>');
  //     $("#cnav-swith-con .wh-hd-custom-menu");
  // })
